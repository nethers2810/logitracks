...
const links = [
  ['Dashboard', '/dashboard'], ['Products', '/products'], ['Truck Types', '/truck-types'], ['Stacking Rules', '/stacking-rules'],
  ['Customers', '/customers'], ['Vendor Allocation', '/vendor-allocation'], ['Orders', '/orders'], ['Import Center', '/imports']
];
  ...
  return (
    <div className="flex min-h-screen">
      <aside className="w-64 border-r border-slate-200 bg-white p-4">
        <h1 className="text-lg font-semibold">Smart Cubication</h1>

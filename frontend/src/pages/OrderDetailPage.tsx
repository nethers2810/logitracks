...
export function OrderDetailPage() {
  ...
  return <QueryBlock isLoading={isLoading} isError={isError} isEmpty={!data}><div className="space-y-4">
    <div className="flex items-center justify-between"><h2 className="text-2xl font-semibold">Order Detail</h2><Link className="rounded bg-brand-600 px-3 py-2 text-sm text-white" to={`/simulation/${data!.header.order_id}`}>View simulation</Link></div>
